...
export const questions: Question[] = [
  ...
  // Section 4: Baseline
  {
    ...
    text: { en: "How would you rate your level of AI and digital literacy?", bm: "Bagaimanakah anda menilai tahap literasi AI dan digital anda?" },
    options: [], nextId: "q4b",
  },
  {
    ...
    text: { en: "I am confident in using AI and digital tools for my business.", bm: "Saya yakin menggunakan AI dan alat digital untuk perniagaan saya." },
    options: [], nextId: "q4c",
  },
  {
  ...
  {
    id: "q4e", section: "Baseline", type: "multi",
    text: { en: "Which of the following AI tools or platforms have you used for your business? (Tick all that apply)", bm: "Antara alat atau platform AI berikut, yang manakah pernah anda gunakan untuk perniagaan anda? (Tandakan semua yang berkenaan)" },
    options: [
      { id: "q4e_1", label: { en: "ChatGPT / Claude / Gemini",                                        bm: "ChatGPT / Claude / Gemini" },                                        points: 0 },
      { id: "q4e_2", label: { en: "Canva AI",                                                         bm: "Canva AI" },                                                         points: 0 },
      { id: "q4e_3", label: { en: "Meta AI / TikTok AI features",                                     bm: "Meta AI / Ciri AI TikTok" },                                         points: 0 },
      { id: "q4e_4", label: { en: "Grammarly / Notion AI",                                            bm: "Grammarly / Notion AI" },                                            points: 0 },
      { id: "q4e_5", label: { en: "Google Analytics / Meta Insights",                                 bm: "Google Analytics / Meta Insights" },                                 points: 0 },
      { id: "q4e_6", label: { en: "AI chatbots for customer service (e.g. Tidio, ManyChat)",          bm: "Chatbot AI untuk khidmat pelanggan (contohnya Tidio, ManyChat)" },    points: 0 },
      { id: "q4e_7", label: { en: "AI accounting tools (e.g. Wave, QuickBooks AI)",                   bm: "Alat perakaunan AI (contohnya Wave, QuickBooks AI)" },                points: 0 },
      { id: "q4e_8", label: { en: "AI image/video generators (e.g. Adobe Firefly, CapCut AI)",        bm: "Penjana imej/video AI (contohnya Adobe Firefly, CapCut AI)" },       points: 0 },
    ],
    nextId: "q4f",
  },
  {
    id: "q4f", section: "Baseline", type: "single",
    text: { en: "How often do you use AI tools for your business?", bm: "Berapa kerap anda menggunakan alat AI untuk perniagaan anda?" },
    options: [
      { id: "q4f_1", label: { en: "Never",               bm: "Tidak pernah" },          points: 0 },
      { id: "q4f_2", label: { en: "Rarely",              bm: "Jarang" },                points: 0 },
      { id: "q4f_3", label: { en: "A few times a month", bm: "Beberapa kali sebulan" }, points: 0 },
      { id: "q4f_4", label: { en: "A few times a week",  bm: "Beberapa kali seminggu" }, points: 0 },
      { id: "q4f_5", label: { en: "Daily",               bm: "Setiap hari" },           points: 0 },
    ],
    nextId: "q4g",
  },
  {
    id: "q4g", section: "Baseline", type: "multi", maxSelections: 4,
    text: { en: "What type of digital and AI-related training resources are you currently looking for in your entrepreneurial journey? (Select up to 4 options)", bm: "Apakah jenis latihan atau sumber pembelajaran berkaitan digital dan AI yang sedang anda cari dalam perjalanan keusahawanan anda? (Pilih sehingga 4 pilihan)" },
    options: [
      { id: "q4g_1", label: { en: "Using AI tools to automate business tasks",                                   bm: "Menggunakan alat AI untuk mengautomasikan tugas perniagaan" },                              points: 0 },
      { id: "q4g_2", label: { en: "Setting up and managing an online business presence",                         bm: "Menubuhkan dan mengurus kehadiran perniagaan dalam talian" },                              points: 0 },
      { id: "q4g_3", label: { en: "Digital marketing and social media strategies",                               bm: "Pemasaran digital dan strategi media sosial" },                                           points: 0 },
      { id: "q4g_4", label: { en: "Understanding data and analytics for business decisions",                     bm: "Memahami data dan analitik untuk membuat keputusan perniagaan" },                          points: 0 },
      { id: "q4g_5", label: { en: "Cybersecurity and protecting your business online",                           bm: "Keselamatan siber dan perlindungan perniagaan dalam talian" },                            points: 0 },
      { id: "q4g_6", label: { en: "E-commerce and digital payment systems",                                      bm: "E-dagang dan sistem pembayaran digital" },                                                points: 0 },
      { id: "q4g_7", label: { en: "Using productivity and collaboration software (e.g., Google Workspace, Canva, Notion)", bm: "Menggunakan perisian produktiviti dan kolaborasi (contohnya Google Workspace, Canva, Notion)" }, points: 0 },
      { id: "q4g_8", label: { en: "AI-powered customer engagement tools (e.g., chatbots, CRM systems)",         bm: "Alat penglibatan pelanggan berasaskan AI (contohnya chatbot dan sistem CRM)" },             points: 0 },
    ],
    nextId: "q4h",
  },
  {
    id: "q4h", section: "Baseline", type: "single",
    ...
    options: [
      { id: "q4h_1", label: { en: "Always",    bm: "Sentiasa" },      points: 0 },
      { id: "q4h_2", label: { en: "Sometimes", bm: "Kadang-kadang" }, points: 0 },
      { id: "q4h_3", label: { en: "Seldom",    bm: "Jarang" },        points: 0 },
      { id: "q4h_4", label: { en: "Never",     bm: "Tidak pernah" },  points: 0 },
    ],
    nextId: "q6a",
  },
  ...
  },
  {
    ...
    text: {
      en: "If fully or partially paid, how much do you receive per month for your care work (in RM)? (If unpaid or not applicable, enter 0)",
      bm: "Jika sepenuhnya atau sebahagiannya berbayar, berapakah jumlah yang anda terima setiap bulan untuk kerja penjagaan yang anda lakukan (dalam RM)? (Jika tidak berbayar atau tidak berkenaan, masukkan 0)",
    },
    options: [],
