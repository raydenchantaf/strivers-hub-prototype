export const footer = {
  en: {
    ...
    "footer2.implementing_partner": "Implementing Partner",
    "footer2.supported_by":      "In partnership with",
    ...
    "footer2.rights":            "© 2024 - 2026 Mastercard Strive Malaysia",
    ...
    "footer.rights":             "© 2024 - 2026 Strivers\' Hub. All rights reserved.",
  },
  bm: {
    "footer2.strategic_partner": "Rakan Strategik",
    "footer2.implementing_partner": "Rakan Pelaksana",
    "footer2.supported_by":      "Dengan kerjasama",
    ...
    "footer.rights":             "© 2024 - 2026 Strivers\' Hub. Hak cipta terpelihara.",
  },
};
